...
// Validate ../../app/api/auth/discord/login/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/auth/discord/login">> = Specific
  const handler = {} as typeof import("../../app/api/auth/discord/login/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
